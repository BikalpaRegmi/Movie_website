...
const MovieComponent = (props) => {
 const {backdrop_path,original_title,release_date,vote_average} = props.data;
  
    return (
   <>
          
        <div className='border p-3 border-blue-500 bg-slate-950 hover:bg-slate-800'>   
        <img src={`https://image.tmdb.org/t/p/original/${backdrop_path}`} alt=" the image is not supported" className='rounded-3xl w-96 md:h-40 h-64 p-3 opacity-70'/>
